...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const crewMembers = [
    ...
    { name: "RORONOA ZORO", desc: "Zoro is the crew’s swordsman and Luffy’s steadfast right hand. With his three-sword style and indomitable will, he pushes toward his dream of becoming the world’s strongest swordsman. Gruff but loyal, Zoro’s sacrifices prove his devotion to protecting Luffy’s path and the crew’s future.", gradient: "linear-gradient(90deg, #64D619 0%, #539E21 100%)", bgGif: "../img/gifs/crew-zoro-bg.gif", charImg: "../img/crew-zoro.png" },
    ...
    { name: "TONY TONY CHOPPER", desc: "Chopper is the doctor of the crew, a reindeer who gained human traits after eating the Human-Human Fruit. Using medicine and Rumble Ball transformations, he fights to cure any disease and protect his friends. Though often mistaken as a pet, Chopper is beloved family.", gradient: "linear-gradient(90deg, #F825A7 0%, #FE60A4 100%)", bgGif: "../img/gifs/crew-chopper-bg.gif", charImg: "../img/crew-chopper all forms.png" },
