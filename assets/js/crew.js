...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const crewMembers = [
    ...
    { name: "CAT BURGLAR NAMI", desc: "Nami, the Straw Hats’ navigator, dreams of mapping the entire world while guiding the crew safely across dangerous seas. Known as the “Cat Burglar,” she pairs cunning and mastery of the Clima-Tact to weaponize the weather itself. Her journey from enslavement to freedom reflects the crew’s fight for dreams unchained.", gradient: "linear-gradient(90deg, #FF8C00 0%, #FBAF24 100%)", bgGif: "assets/img/gifs/crew-nami-bg.gif", charImg: "assets/img/crew-nami.png" },
